...
path('employee-lock-status/', employee_lock_status_view, name='employee_lock_status'),
    ...
    path('task/', task_handler, name='task_handler'),
    path('update/', update_task_datetime, name='update_task_datetime'),
...
path('payslips/send-to-hr/', send_payslips_to_hr, name='send_payslips_to_hr'),
path('payslips/send-to-employees/payslips/send-to-employees/',send_payslips_to_employees, name='send_payslips_to_employees'),
    path('user_payslip/<int:user_id>',user_payslip_list,name='user_payslip'),
    path('export_payslip_csv/',export_payslip_csv, name='export_payslip_csv'),
   ...
   # path('dashboard_view',dashboard_view,name='dashboard_view'),
    ...
    path("chat/", chatbot_view, name="chat_api"),
    path('profile/', profile_form_view, name='profile_form'),
    path('profile/thank-you/',profile_thank_you_view, name='profile_thank_you'),
...
path('task/update/<int:task_id>/',update_task_status_page, name='update_task_status_page'),
    path('payslip-view/', view_latest_payslip, name='view_latest_payslip'),
    path('generate-payslip/', manual_generate_payslip, name='manual_generate_payslip'),
path('recommendations/', get_skill_recommendations, name='skill_recommendations'),
    path('feedback/', submit_skill_feedback, name='submit_feedback'),

    # path('run-skill-recommendation/', run_skill_recommendation, name='run_skill_recommendation'),

   # path('recommend-project-members/', ProjectRecommendationView.as_view(), name='recommend_project_members'),
path('user_timesheet',user_timesheet,name='user_timesheet'),
   ...
   # path('get_existing_data/<str:category>/',get_existing_data, name='get_existing_data'),
    ...
    path('project_detail/<int:pk>/',project_edit_view, name='project_detail'),
